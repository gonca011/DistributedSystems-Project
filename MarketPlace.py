    ...
    if categorias:
        for categoria in categorias:
            ...
            if produtos:
                ...
                produtos_disponiveis[categoria].extend(produtos)
...
def load_gestor_public_key(cert_path):
...
# Load the gestor public key
public_key_gestor = load_gestor_public_key(r'.\certificado_gestor.pem')
...
def iniciar_marketplace():
    ...
    while True:
        ...
        print("8. Listar categorias seguros")
        print("9. Listar produtos seguros")
        print("10. Comprar produto seguro")
        print("11. Sair")
        option = input("Opção: ")
        ...
        if option == "1":
            ...
            if produtos is None:
                print("Erro: Não foi possível obter a lista de produtos. A tentar conectar a outro produtor.")
            ...
            categorias = listar_categorias_seguras(cliente_selecionado)
            print(categorias)

        elif option == "9":
            produtos = buscar_categorias_e_produtos_seguro(cliente_selecionado)
            print(produtos)
